# -*- coding: utf-8 -*-
"""2_4o_habitatprompt_eBird.ipynb

# Install dependencies
"""

# Commented out IPython magic to ensure Python compatibility.
# %pip install -qU langchain langchain-openai langchain-community langchain-experimental pandas gradio openai
...
Run this to generate the chatbox interface app. (Note: for now it's called Seamus bc a much earlier iteration using a PDF file as context started hallucinating and talking about Seamus Heaney...so it stuck)
"""
